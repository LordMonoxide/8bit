...
public enum CPUInstructions {
  NOOP(op()),
  LDA(op()
    .step(CPUControls.ADD_EN, CPUControls.ADD_IN, CPUControls.CNT_EN, CPUControls.CNT_OUT)
  ...
  OUT(op()
    .step(CPUControls.OUT_EN, CPUControls.OUT_IN, CPUControls.A_EN, CPUControls.A_OUT)
  ),
  TEST(op()
    .step(CPUControls.CNT_EN, CPUControls.CNT_OUT, CPUControls.ADD_EN, CPUControls.ADD_IN)
  ...
  private final static class MicroInstruction {
    ...
    private MicroInstruction() {
      this.step(CPUControls.CNT_EN, CPUControls.CNT_OUT, CPUControls.ADD_EN, CPUControls.ADD_IN);
